  ...
  return (
    <div className="fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-6 lg:px-36 py-5">
      ...
      <div
       ...
       max-md:test-lg z-50 flex flex-col md:flex-row items-center
       max-md:justify-center gap-8 mid-md:px-8 py-3 max-md:h-screen
       min-md:rounded-full backdroup-blur bg-black/70 md:bg-white/10 md:border
